<section class="w-full">
    ...
    <x-data-table :headers="$this->headers" :rows="$this->rows">
        ...
        @interact('estado', $row)
            ...
            @if ($row->estado === 'por_realizarse')

                <flux:badge color="zinc" size="sm">
                    ⏳ Por realizarse
                </flux:badge>

            @elseif ($row->estado === 'en_curso')
    ...
    <flux:modal name="torneo-form" class="min-w-[30rem]">
        ...
        <div class="space-y-6">
            ...
            >
                ...
                <flux:select.option value="interno">
                    🏠 Interno
                </flux:select.option>

                <flux:select.option value="externo">
                    🌎 Externo
                </flux:select.option>
            ...
            >
                ...
                <flux:select.option value="por_realizarse">
                    ⏳ Por realizarse
                </flux:select.option>

                <flux:select.option value="en_curso">
                    🔥 En curso
                </flux:select.option>

                <flux:select.option value="finalizado">
                    🏆 Finalizado
                </flux:select.option>
            ...
            <div class="flex justify-end gap-2">
                ...
                <flux:button
                    wire:click="{{ $torneo_id ? 'update' : 'save' }}"
                    variant="primary"
                >
    ...
    <flux:modal name="view-torneo">
        ...
        <div class="space-y-4">
            ...
            <p class="text-sm">
                ...
                @if ($selectedTorneo?->estado === 'por_realizarse')

                    ⏳ Por realizarse

                @elseif ($selectedTorneo?->estado === 'en_curso')
