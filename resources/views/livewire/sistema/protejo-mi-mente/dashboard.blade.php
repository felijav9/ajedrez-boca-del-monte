<div class="dashboard-wrapper">
    ...
    <div class="dashboard-container">
        <div class="header-section">
            <img src="{{ asset('img/protejo-mi-mente.png') }}" alt="Protejo Mi Mente" class="brand-image">
            ...
            <nav class="nav-grid">
                ...
                <button 
                   wire:click="goToTorneos" 
                    class="nav-btn {{ request()->routeIs('protejo-mi-mente.torneos-protejo') ? 'nav-btn-selected' : '' }}">
                    Torneos
                </button>

                {{-- JUGADORES: Negro si seleccionado, sino blanco --}}
                <button 
                    wire:click="goToJugadores" 
                    class="nav-btn {{ request()->routeIs('protejo-mi-mente.jugadores-protejo') ? 'nav-btn-selected' : '' }}">
                    Jugadores
                </button>

                {{-- MEDALLERO: Negro si seleccionado, sino blanco --}}
                <button 
                    wire:click="goToMedallero" 
                    class="nav-btn {{ request()->routeIs('protejo-mi-mente.medallero') ? 'nav-btn-selected' : '' }}">
                    Medallero
                </button>
            </nav>
        </div>
