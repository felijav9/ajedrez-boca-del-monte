...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // AJEDREZ
        $paginaAjedrez = Page::create([
            'label' => 'Protejo Mi Mente',
            'icon' => 'bike',
            'type' => 'parent',
            'permission_name' => 'page.view.protejo-mi-mente'
        ]);

        Page::create([
            'label' => 'Registro de jugadores',
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.registro-jugadores',
            'order' => 1,
            'type' => 'page',
            'permission_name' => 'page.view.protejo-mi-mente.registro-jugadores',
            'page_id' => $paginaAjedrez->id
        ]);
        Page::create([
            'label' => 'Registro de torneos',
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.registro-torneos',
            'order' => 2,
            'type' => 'page',
            'permission_name' => 'page.view.protejo-mi-mente.registro-torneos',
            'page_id' => $paginaAjedrez->id
        ]);
        Page::create([
            'label' => 'Registro de equipos',
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.registro-equipos',
            'order' => 3,
            'type' => 'page',
            'permission_name' => 'page.view.protejo-mi-mente.registro-equipos',
            'page_id' => $paginaAjedrez->id
        ]);
        ...
        Page::create([
            'label' => 'Categorias',
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.registro-categorias',
            'order' => 4,
            'type' => 'page',
            'permission_name' => 'page.view.protejo-mi-mente.registro-categorias',
            'page_id' => $paginaAjedrez->id
        ]);

        Page::create([
            'label' => 'Registro de Jugadores a Torneos',
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.ingreso-jugadores-torneos',
            'order' => 5,
            'type' => 'page',
            'permission_name' => 'page.view.protejo-mi-mente.ingreso-jugadores-torneos',
            'page_id' => $paginaAjedrez->id
        ]);
        ...
        Page::create([
            ...
            'icon' => 'document-text',
            'route' => 'protejo-mi-mente.registro-resultados-individuales',
            'order' => 5,
            'type' => 'page',
        ...
        Permission::create([
            'name' => 'page.view.protejo-mi-mente',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);

        Permission::create([
            'name' => 'page.view.protejo-mi-mente.registro-jugadores',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);

        Permission::create([
            'name' => 'page.view.protejo-mi-mente.registro-torneos',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);

        Permission::create([
            'name' => 'page.view.protejo-mi-mente.registro-equipos',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);

        Permission::create([
            'name' => 'page.view.protejo-mi-mente.ingreso-jugadores-torneos',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);

        Permission::create([
            'name' => 'page.view.protejo-mi-mente.registro-categorias',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);
        Permission::create([
            'name' => 'page.view.protejo-mi-mente.registro-resultados-individuales',
            'guard_name' => 'web',
            'module' => 'menu'
        ]);
